...
const IRS = () => {
  ...
  return (
    ...
    <form className="mt-16 px-4">
      ...
      <div className="flex items-center gap-2 px-5 py-2 w-56 mt-5 ml-20 bg-[#5B0F12] text-slate-50 rounded-md xl:ml-0"><span></span><LuSend /><span>Submit Request</span></div>
    </form>
